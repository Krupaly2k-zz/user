...
if (isset($_POST["submit"])) {
    ...
    if (empty($result)) {
        $sql = "insert into tbl_registered_users (name,email, password, active) values('$name','$email','$password', '0')";
		...
		$conn = mysqli_connect("localhost", "root", "", "user");
				...
				$sql = "select id from tbl_registered_users order by id desc limit 1";
